...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.html"><b>T<br>H<br>E</b>Big Store<span>THE BEST MALL</span></a></h1>
			</div>
			<!--begin of menu-->
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						...
						<c:forEach items= "${listAllCategory}" var = "c"> 
							...
							<li><a href="category?cid=${c.cid()}" class=" hyper"><span>${c.cname}</span></a>
							</li>
		...
		<div class="container">
			<div class="spec ">
				...
				<div class=" con-w3l agileinf">
							<!-- ----- edit here ----------- -->
							<c:forEach items="${sessionScope.listAllProducts}" var="listPC">
					...
					<c:forEach var="listPC" items="${sessionScope.listAllProducts}">
