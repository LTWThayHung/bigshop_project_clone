...
<title>Big store a Ecommerce Online Shopping Category Flat
	Bootstrap Responsive Website Template | Hold :: w3layouts</title>
<!-- for-mobile-apps -->
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class=""><a href="kitchen.jsp"
								class="hyper" ><span>Kitchen
										</span></a>
								</li>
							<li><a href="care.jsp"
								class="hyper" ><span>
							...
							<li class="active active1"><a href="hold.jsp"
								class="hyper"><span>Household</span></a>
								</li>
	...
	<div class="kic-top ">
		<div class="container ">
			...
			<div class="col-md-4 kic-top1">
				<a href="single.html"> <img src="images/ki6.jpg"
			...
			<div class="col-md-4 kic-top1">
				<a href="single.html"> <img src="images/ki7.jpg"
					class="img-responsive" alt="">
				</a>
				<h6>Cleaning Wear</h6>
				<p>Nam libero tempore</p>
			...
			<div class="col-md-4 kic-top1">
				<a href="single.html"> <img src="images/ki8.jpg"
					class="img-responsive" alt="">
				</a>
				<h6>Toothbrush</h6>
				<p>Nam libero tempore</p>
	...
	<div class="product">
		<div class="container">
			...
			<div class=" con-w3l agileinf">
				...
				<!-- hiển thị tất cả sản phẩm   -->
				<c:forEach var="listHh" items="${sessionScope.listHoldHouse}">
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal" data-target="#myModal${listHh.id}"
								data-id="${listHh.id}"
								> <img
								src="${listHh.image}" class="img-responsive" alt="">
							</a>
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.jsp">${o.title}</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
										<label>$${listHh.price} </label><em class="item_price">$${listHh.discount_price}</em>
									</p>
									<div class="block">
								...
								<div class="add add-2">
									<button class="btn btn-danger my-cart-btn my-cart-b"
										data-id="${listHh.id}" data-name="${listHh.title}" data-summary="summary 1"
										data-price="${listHh.discount_price}" data-quantity="1"
										data-image="${listHh.image}">Add to Cart</button>
								</div>
							</div>
						</div>
					</div>
				...
				<!-- Modal sẽ hiển thị thông tin sản phẩm -->
					<c:forEach var="listHh" items="${sessionScope.listHoldHouse}">
						<div class="modal fade" id="myModal${listHh.id}" tabindex="-1"
								...
								<div class="modal-content modal-info">
									...
									<div class="modal-body modal-spa">
										<div class="col-md-5 span-2">
											<div class="item">
												<img src="${listHh.image}" class="img-responsive" alt="">
											</div>
										</div>
										<div class="col-md-7 span-1 ">
											<h3>${listHh.title}</h3>
											<p class="in-para">${listHh.description}</p>
											<div class="price_single">
												<span class="reducedfrom "><del>$${listHh.price}
													</del>$${listHh.discount_price}</span>
