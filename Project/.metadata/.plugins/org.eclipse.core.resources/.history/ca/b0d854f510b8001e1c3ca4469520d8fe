...
<body>
	...
	<div class="banner-top">
		<div class="container">
			<h3>Lorem</h3>
			<h4>
				<a href="index.jsp">Home</a><label>/</label>Lorem
			</h4>
			<div class="clearfix"></div>
		</div>
	</div>
				...
				<div class="col-md-5 single-top">
					<div class="single-w3agile">
						...
						<div id="picture-frame">
							<img src="${product.image}" data-src="images/si-1.jpg" alt=""
	...
	<div class="content-top offer-w3agile">
		<div class="container ">
			...
			<div class=" con-w3l wthree-of">
				...
				<c:forEach var="listSingle" items="${sessionScope.listSingle}">
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal"
								data-target="#myModal${listSingle.id}"
								data-id="${listSingle.id}"> <img
								src="${listSingle.image}" class="img-responsive" alt="">
							</a>
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.jsp">${listSingle.title}</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
										<label>$${listSingle.price} </label><em class="item_price">$${listSingle.discount_price}</em>
									</p>
									<div class="block">
										<div class="starbox small ghosting"></div>
									</div>
								...
								<div class="add add-2">
									<button class="btn btn-danger my-cart-btn my-cart-b"
										data-id="${listSingle.id}" data-name="${listSingle.title}"
										data-summary="summary 1"
										data-price="${listSingle.discount_price}" data-quantity="1"
										data-image="${listSingle.image}">Add to Cart</button>
								</div>
							</div>
						</div>
					</div>
				...
				<c:forEach var="listSingle" items="${sessionScope.listSingle}">
					<div class="modal fade" id="myModal${listSingle.id}" tabindex="-1"
							...
							<div class="modal-content modal-info">
								...
								<div class="modal-body modal-spa">
									<div class="col-md-5 span-2">
										<div class="item">
											<img src="${listSingle.image}" class="img-responsive" alt="">
										</div>
									</div>
									<div class="col-md-7 span-1 ">
										<h3>${listSingle.title}</h3>
										<p class="in-para">${listSingle.description}</p>
										<div class="price_single">
											<span class="reducedfrom "><del>$${listSingle.price}
												</del>$${listSingle.discount_price}</span>

											<div class="clearfix"></div>
										</div>
										<div class="add-to">
											<button class="btn btn-danger my-cart-btn my-cart-btn1 "
												data-id="${listSingle.id}" data-name="Moong"
												data-summary="summary 1"
												data-price="${listSingle.discount_price}" data-quantity="1"
												data-image="${listSingle.image}">Add to Cart</button>
										</div>
