					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal"
								data-target="#myModal${listHh.id}" data-id="${listHh.id}">
							...
							<div class="mid-1">
								...
								<div class="add add-2">
									<button class="btn btn-danger my-cart-btn my-cart-b"
										data-id="${listHh.id}" data-name="${listHh.title}"
										data-summary="summary 1" data-price="${listHh.discount_price}"
										data-quantity="1" data-image="${listHh.image}">Add to
										Cart</button>
								</div>
							</div>
						</div>
